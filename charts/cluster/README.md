...
There is a separate document outlining logical replication setup here: **[Logical Replication](<docs/Logical Replication.md>)**
...
| publications | list | `[]` | Logical replication publications. Publications define what data to replicate from this cluster. Requires wal_level: logical in cluster.postgresql.parameters. See: https://cloudnative-pg.io/docs/devel/logical_replication/ |
...
| subscriptions | list | `[]` | Logical replication subscriptions. Subscriptions receive data from a publication on another cluster. Requires an externalCluster entry in logicalReplication.externalClusters. See: https://cloudnative-pg.io/docs/devel/logical_replication/ |
